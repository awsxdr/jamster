...
Jamster includes components from third-party projects. See [`crg-shim/README.md`](crg-shim/README.md) for details of the CRG scoreboard components used and their licenses.