...
public class TimeoutClockUnitTests : ReducerUnitTest<TimeoutClock, TimeoutClockState>
{
    ...
    public async Task JamStarted_WhenClockRunning_AndEndTickNotSet_SendsTimeoutEndedEvent()
    {
        ...
        State = new(true, randomTick, 0, TimeoutClockStopReason.None, 0);
    ...
    {
        State = new(true, 0, 9000, TimeoutClockStopReason.Other, 9000);
    ...
    {
        State = new(true, 0, endTickSet ? 9000 : 0, endTickSet ? TimeoutClockStopReason.Other : TimeoutClockStopReason.None, endTickSet ? 9000 : 10000);
    ...
    {
        State = new(false, 0, 0, TimeoutClockStopReason.None, 0);
    ...
    {
        State = new(true, 10000, 30000, TimeoutClockStopReason.Other, 40000);
        var initialState = State;
    ...
    {
        State = new(true, 0, 0, TimeoutClockStopReason.None, 0);
    ...
    {
        State = new TimeoutClockState(true, 0, 0, TimeoutClockStopReason.None, 10000);
    ...
    public async Task PeriodFinalized_StopsClock()
    {
        ...
        State.Should().Be(new TimeoutClockState(false, 0, 11000, TimeoutClockStopReason.PeriodFinalized, 11000));
    }
    ...
    {
        State = new(true, 0, 0, TimeoutClockStopReason.None, 20000);
    ...
    {
        var state = new TimeoutClockState(true, 1234, 4321, TimeoutClockStopReason.PeriodExpired, 5678);
        ...
        deserialized["endTick"]!.AsValue().GetValue<int>().Should().Be(4321);
        deserialized["stopReason"]!.AsValue().GetValue<string>().Should().Be("PeriodExpired");
