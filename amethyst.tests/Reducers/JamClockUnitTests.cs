...
public class JamClockUnitTests : ReducerUnitTest<JamClock, JamClockState>
{
    ...
    public async Task JamStart_WhenClockRunning_DoesNotChangeState()
    {
        ...
        State = new JamClockState(true, randomTick, 0, 0, true);
    ...
    {
        State = new JamClockState(true, 0, 0, 0, true);
    ...
    public async Task JamEnded_WhenClockRunning_EndsJam()
    {
        ...
        State = new(true, randomTick, randomTick, 0, true);
    ...
    {
        var randomTick = Random.Shared.Next(1, 100000);
        State = new(false, randomTick, randomTick, randomTick / 1000, true);
    ...
    {
        State = new(true, 0, 100, 100, false);
    ...
    {
        State = new(true, 0, 10000, 10, true);
    ...
    {
        State = new(false, 0, 10000, 10, true);
    ...
    {
        State = new JamClockState(true, 0, 10000, 10, true);
        MockState<RulesState>(new(Rules.DefaultRules with
        {
