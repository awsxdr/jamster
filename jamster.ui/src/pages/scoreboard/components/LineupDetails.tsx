...
import { useI18n, useLineupClockState, useOvertimeState, usePeriodClockState } from "@/hooks";
...
export const LineupDetails = ({ gameStage, visible }: LineupDetailsProps) => {
    ...
    const jamWillStart = useMemo(
        () => isInOvertime || lineupClock && periodClock && (30 * 60 - periodClock.secondsPassed) - (30 - lineupClock.secondsPassed) > 0,
        [periodClock?.secondsPassed, lineupClock?.secondsPassed, isInOvertime]
    );
