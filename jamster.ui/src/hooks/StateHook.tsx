...
export const useOvertimeState = () => useGameState<OvertimeState>("OvertimeState");
...
export const usePostGameClockState = () => useGameState<PostGameClockState>("PostGameClockState");
