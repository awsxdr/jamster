            ...
            <CardContent className="pt-4 flex flex-col gap-4">
                ...
                <Section header="Color">
                    ...
                    <div className="w-full flex items-center">
                        <div className="grow md:grow-0 md:min-w-72 inline-block">Shirt color</div>
                        <ColorSelectButton color={shirtColor} onColorChanged={setShirtColor} onClose={handleShirtColorClose} />
                    </div>
                    <div className="w-full flex items-center">
                        <div className="grow md:grow-0 md:min-w-72 inline-block">Complementary color</div>
                        <ColorSelectButton color={complementaryColor} onColorChanged={setComplementaryColor} onClose={handleComplementaryColorClose} />
                    </div>
                </Section>
                <Separator />
                <Section header="Skaters">
                    <RosterInput existingNumbers={roster.map(s => s.number)} onSkatersAdded={handleSkatersAdded} />
                    <RosterTable roster={roster} onSkaterChanged={handleSkaterChanged} onSkaterDeleted={handleSkaterDeleted} />
                </Section>
            </CardContent>
        </Card>
    );
